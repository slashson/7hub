...
(function () {
  ...
  var ENTRIES = [
    ...
    { s: '.rules__text', h: true,
      uk: 'Тиша з 22:00 до 08:00.<br><br>Заборонено палити в приміщенні.<br><br>З тваринами — за окремою домовленістю.<br><br>Заїзд після 14:00, виїзд до 12:00.<br>Раннє/пізнє — на запит.<br><br>Перед виїздом — фото показників лічильника надсилається в бот.',
      ru: 'Тишина с 22:00 до 08:00.<br><br>Курить в помещении запрещено.<br><br>С животными — по отдельной договорённости.<br><br>Заезд после 14:00, выезд до 12:00.<br>Ранний/поздний — по запросу.<br><br>Перед выездом — фото показаний счётчика отправляется в бот.',
      en: 'Quiet hours 22:00–08:00.<br><br>No smoking indoors.<br><br>Pets by separate arrangement.<br><br>Check-in after 14:00, check-out by 12:00.<br>Early/late — on request.<br><br>Before leaving, send a meter photo to the bot.' },
